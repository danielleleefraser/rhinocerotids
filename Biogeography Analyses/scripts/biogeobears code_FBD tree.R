...
trfn = here("FBD_tree.newick")
tr = read.tree(trfn)
tr$root.edge<-NULL
randtree<-multi2di(tr, random = FALSE)
randtree$edge.length <-  randtree$edge.length + 0.000001
tr<-randtree
write.tree(tr,file="Tree.newick")


trfn = here("Tree.newick")

moref(geogfn)

tipranges = getranges_from_LagrangePHYLIP(lgdata_fn=geogfn) # where is this function coming from.
tipranges
...
#### Now running the actual biogeographic models
...
# BioGeoBEARS_run_object$timesfn = "timeperiods_35.txt" #use timeperiods_21 for 21 Ma strat analysis
...
setwd(here("biogeo output unstrat//"))
...
runslow = TRUE
resfn = "Rhinos_DEC_M0_unconstrained_v1.Rdata"
if (runslow)
{
...
# Set up a time- analysis:
# BioGeoBEARS_run_object$timesfn = "timeperiods_35.txt" #"timeperiods_35.txt" #use timeperiods_21 for 21 Ma strat analysis
# BioGeoBEARS_run_object$dispersal_multipliers_fn = "manual_dispersal_multipliers.txt"
...
resfn = "Rhinos_DEC+J_M0_unconstrained_v1.Rdata"
runslow = TRUE
if (runslow)
{
...
# pdffn = "Rhinocerotidae_DEC_vs_DEC+J_M0_unconstrained_v1.pdf"
# pdf(pdffn, width=6, height=6)
# 
# analysis_titletxt ="BioGeoBEARS DEC on Rhinocerotidae M0_unconstrained"
...
#######################################################
#analysis_titletxt ="BioGeoBEARS DEC+J on Rhinocerotidae M0_unconstrained"
...
runslow = TRUE
resfn = "Rhinos_DIVALIKE_M0_unconstrained_v1.Rdata"
if (runslow)
{
  res = bears_optim_run(BioGeoBEARS_run_object)
  res    
...
resfn = "Rhinos_DIVALIKE+J_M0_unconstrained_v1.Rdata"
runslow = TRUE
if (runslow)
{
  #sourceall("/Dropbox/_njm/__packages/BioGeoBEARS_setup/")
...
# pdffn = "Rhinos_DIVALIKE_vs_DIVALIKE+J_M0_unconstrained_v1.pdf"
# pdf(pdffn, width=6, height=6)

#######################################################
# Plot ancestral states - DIVALIKE
#######################################################
#analysis_titletxt ="BioGeoBEARS DIVALIKE on Rhinos M0_unconstrained"
...
#######################################################
#analysis_titletxt ="BioGeoBEARS DIVALIKE+J on Rhinos M0_unconstrained"
...
runslow = TRUE
resfn = "Rhinos_BAYAREALIKE_M0_unconstrained_v1.Rdata"
if (runslow)
{
  res = bears_optim_run(BioGeoBEARS_run_object)
  res    
...
resfn = "Rhinos_BAYAREALIKE+J_M0_unconstrained_v1.Rdata"
runslow = TRUE
if (runslow)
{
  res = bears_optim_run(BioGeoBEARS_run_object)
...
#######################################################
#analysis_titletxt ="BioGeoBEARS BAYAREALIKE on Rhinocerotidae M0_unconstrained"
...
# 
# # States
# res2 = plot_BioGeoBEARS_results(results_object, analysis_titletxt, addl_params=list("j"), plotwhat="text", label.offset=0.45, tipcex=0.7, statecex=0.6, splitcex=0.6, titlecex=0.8, plotsplits=TRUE, cornercoords_loc=scriptdir, include_null_range=TRUE, tr=tr, tipranges=tipranges)
# 
# # Pie chart
# plot_BioGeoBEARS_results(results_object, analysis_titletxt, addl_params=list("j"), plotwhat="pie", label.offset=0.3, tipcex=0.4, statecex=0.3, splitcex=0.3, titlecex=0.8, plotsplits=TRUE, cornercoords_loc=scriptdir, include_null_range=TRUE, tr=tr, tipranges=tipranges)

#######################################################
# Plot ancestral states - BAYAREALIKE+J
#######################################################
# analysis_titletxt ="BioGeoBEARS BAYAREALIKE+J on Rhinos M0_unconstrained"
# 
# # Setup
...
pdffn = paste0("Rhinos_", model_name, "_v1.pdf")
pdf(pdffn, width=6, height=6)

analysis_titletxt = paste0(model_name, " on Rhinos")
...
# Pie chart
plot_BioGeoBEARS_results(results_object, analysis_titletxt, addl_params=list("j"), plotwhat="pie", label.offset=0.45, tipcex=0.7, statecex=0.3, splitcex=0.3, titlecex=0.8, plotsplits=TRUE, cornercoords_loc=scriptdir, include_null_range=TRUE, tr=tr, tipranges=tipranges)
